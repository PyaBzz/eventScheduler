...
Reasons for Mocha + Chai
- Prior familiarity with the packages

Why dependency injection:
- Untangling of code for better testability

Why mocked repository:
- Limited time so skipped the persistence layer
...
Why CORS:
- To allow requests from the frontend app running in browser on localhost

Environment Setup:
If you're on an Arch Linux machine you're in luck. Just run setup.sh to take these steps. There's room for better automation.
